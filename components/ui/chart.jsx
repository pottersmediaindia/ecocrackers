...
const ChartTooltipContent = React.forwardRef((props, ref) => {
  ...
  return <ChartTooltip ref={ref} {...props} config={config} />;
});
ChartTooltipContent.displayName = "ChartTooltipContent";

const ChartLegend = React.forwardRef(({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey, ...props }, ref) => {
  const config = React.useContext(ChartContext);
...
// Utility function for payload config
